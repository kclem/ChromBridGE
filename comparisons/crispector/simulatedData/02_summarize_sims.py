...
with open(summ_file,'w') as summ_out:
    this_run_id = 0
    while(True):
        tx_reads_file = 'sims/01_simulate_reads.py.sim_%d.tx.fq'%this_run_id
        if not os.path.exists(tx_reads_file):
            break
        crispector_tx_file = 'CRISPECTOR_OUT/sims/01_simulate_reads.py.sim_%d/crispector_output/tx_reads_with_primer_inconsistency.csv'%this_run_id
        crispector_ref1_file = 'CRISPECTOR_OUT/sims/01_simulate_reads.py.sim_%d/crispector_output/ref1/treatment_aligned_reads.csv.gz'%this_run_id
        crispector_ref2_file = 'CRISPECTOR_OUT/sims/01_simulate_reads.py.sim_%d/crispector_output/ref2/treatment_aligned_reads.csv.gz'%this_run_id
        crispector_treatment_unmatched_file = 'CRISPECTOR_OUT/sims/01_simulate_reads.py.sim_%d/crispector_output/treatment_unmatched_reads.fa.gz'%this_run_id
